...
*Analysis by @VELOCITY - Performance Optimization & Sub-Linear Algorithms*
*"The fastest code is the code that doesn't run. The second fastest is the code that runs once."*
