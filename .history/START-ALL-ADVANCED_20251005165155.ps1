...
if (-not (Test-Path "C:\XMRig\dashboard\mining-dashboard-v2.html")) {
    ...
    Write-Host "  ✅ Dashboard copied" -ForegroundColor Green
}
...
if (-not $xmrigProcess) {
    ...
    Write-Host "  [1/4] ✅ XMRig already running (PID: $($xmrigProcess.Id))" -ForegroundColor Green
}
...
Write-Host "        ✅ Optimizer started (PID: $($optimizerJob.Id))" -ForegroundColor Green
...
Write-Host "        ✅ Profit Switcher started (PID: $($switcherJob.Id))" -ForegroundColor Green
...
if (Test-Path "C:\XMRig\dashboard\mining-dashboard-v2.html") {
    ...
    Write-Host "        ⚠️  Dashboard not found" -ForegroundColor Yellow
}
...
Write-Host ""
Write-Host "✅ Launcher closed. Mining continues in background." -ForegroundColor Green
Write-Host ""
