...
class HardwareHealthPredictor:
    ...
    def __init__(self, contamination: float = 0.1):
        ...
        self._score_offset = 0.0  # Calibration offset
    ...
    def predict_health(self, sample: MetricsSample, collector: MetricsCollector) -> HealthReport:
        ...
        with self._lock:
            ...
            # Convert to 0-100 scale using calibrated offset
            # Normal samples cluster around offset; anomalies are below
            adjusted = (raw_score - self._score_offset) / abs(self._score_offset + 0.01)
            health_score = max(0, min(100, 75 + adjusted * 50))
