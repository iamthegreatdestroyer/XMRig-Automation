...
class HardwareHealthPredictor:
    ...
    def predict_health(self, sample: MetricsSample, collector: MetricsCollector) -> HealthReport:
        ...
        with self._lock:
            ...
            # Scores above offset are healthy, below are degraded/critical
            adjusted = raw_score - self._score_offset + 0.1  # Center around 0.1
            health_score = max(0, min(100, 50 + adjusted * 200))
